...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'event.updated_date'
        db.alter_column(u'pyEventOrderWeb_event', 'updated_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'event.updated_date'
        db.alter_column(u'pyEventOrderWeb_event', 'updated_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
