...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'participant.register_time'
        db.add_column(u'pyEventOrderWeb_participant', 'register_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'participant.register_time'
        db.delete_column(u'pyEventOrderWeb_participant', 'register_time')
    ...
    models = {
        ...
        u'pyEventOrderWeb.event': {
            'Meta': {'ordering': "['-updated_date']", 'object_name': 'event'},
        ...
        u'pyEventOrderWeb.participant': {
            'Meta': {'ordering': "['event_ID', 'register_time']", 'object_name': 'participant'},
            ...
            'register_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
