...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'event.updated_date'
        db.add_column(u'pyEventOrderWeb_event', 'updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 11, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'event.updated_date'
        db.delete_column(u'pyEventOrderWeb_event', 'updated_date')
